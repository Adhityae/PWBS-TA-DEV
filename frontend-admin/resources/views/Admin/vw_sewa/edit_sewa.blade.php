                    ...
                    <div class="row formtype">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="txt_kode_pesan" id="txt_kode_pesan" maxlength="8" placeholder="Masukkan Kode Pesan" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="txt_kode_user" id="txt_kode_user" maxlength="8" placeholder="Masukkan Kode User" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txt_status" name="txt_status">
                                    ...
                                    <option id="txt_status" name="txt_status">Belum Bayar</option>
...
<script>
    ...
    document.getElementById("btn_batal").addEventListener('click',
        function () {
            location.href = "{{ url('/Admin/vw_sewa/edit_sewa/updateSewa') }}/" + kode_sewa_lama;
        })
    ...
    document.querySelector("#err_status").style.display = 'none'
        ...
        // Tampilkan data
        let kode_sewa_lama = "{{$kode_sewa_lama}}"

        document.querySelector("#txt_kode_sewa").value = "{{$kode_sewa}}"
        ...
        document.querySelector("#txt_tanggal_keluar").value = "{{$tanggal_keluar}}"
        document.querySelector("#txt_pembayaran").value = "{{$pembayaran}}"
    ...
    const edit = () => {
        ...
        const check = (kode_sewa[2] === 0 && kode_pesan[2] === 0 && kode_user[2] === 0 && kode_kamar[2] === 0 && tanggal_keluar[2] === 0 && pembayaran[2] === 0 && status[2] === 0) ?
            ...
            editData(document.querySelector("#txt_kode_sewa").value,document.querySelector("#txt_kode_pesan").value, document.querySelector("#txt_kode_user").value,
        ...
        const editData = async (kode_sewa, kode_pesan, kode_user, kode_kamar, tanggal_keluar, pembayaran, status) => {
            // Collecting data
            let data = {
                "kode_sewa": kode_sewa,
            ...
            try {
                ...
                let response = await fetch("{{ url('/Admin/vw_sewa/edit_sewa/editSewa') }}/"+kode_sewa_lama, {
                    method: "PUT",
                    headers: {
