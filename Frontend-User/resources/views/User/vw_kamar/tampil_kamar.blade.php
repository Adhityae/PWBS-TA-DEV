...
<title>Sistem Customer E-KOS | Tampil Data Kamar</title>
@endsection
                                        ...
                                        <td class="text-center">
                                            ...
                                            onclick="gotoDetail('{{ $output->kode_kamar }}')">
                                                <i class="fa-solid fa-circle-info"></i></button>
                                                 <a href="{{ route('User/vw_kamar/tambah_kamar') }}" class="btn btn-primary float-right veiwbutton">
                            <i class="fas fa-plus"></i><span> Booking </span></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
