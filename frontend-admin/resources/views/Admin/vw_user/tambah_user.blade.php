...
<title>Sistem Admin E-KOS | Tambah User</title>
@endsection
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title mt-5">Tambah Data User</h3>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    const save = () => {
        ...
        const saveData = async (kode_user, nama, email, password, jk, alamat, no_telepon, status_user, foto_user, role) => {
            ...
            try {
                ...
                let response = await fetch("{{ url('/Admin/vw_user/tambah_user/insertUser') }}", {
                    method: "POST",
                    headers: {
