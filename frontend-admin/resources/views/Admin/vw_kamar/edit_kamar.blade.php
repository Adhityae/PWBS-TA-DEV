...
<title>Sistem Admin E-KOS | Edit Data Kamar</title>
@endsection
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title mt-5">Edit Data Kamar</h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row formtype">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text"name="txt_kode_kamar" id="txt_kode_kamar" maxlength="8" placeholder="" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="txt_nama_kamar" id="txt_nama_kamar" maxlength="50" placeholder="" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txt_lantai" name="txt_lantai">
                                    <option id="txt_lantai" name="txt_lantai">Pilih Lantai</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" type="text"name="txt_deskripsi_kamar" id="txt_deskripsi_kamar" rows="5" placeholder="" ></textarea>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txt_status" name="txt_status">
                                    <option id="txt_status" name="txt_status">Pilih Status</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="txt_harga" id="txt_harga" maxlength="50" placeholder="" />
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="txt_foto_kamar" id="txt_foto_kamar" maxlength="50" placeholder="" />
...
<script>
    ...
    // Fungsi "btn_batal"
        document.querySelector("#btn_batal").addEventListener('click',
            function() {
                location.href = "{{ url('/Admin/vw_kamar/edit_kamar/updateKamar') }}/" + kode_kamar_lama;
            })
    ...
    document.querySelector("#err_foto_kamar").style.display = 'none'
     ...
     // Tampilkan data
        let kode_kamar_lama = "{{$kode_kamar_lama}}"

        document.querySelector("#txt_kode_kamar").value = "{{$kode_kamar}}"
        document.querySelector("#txt_nama_kamar").value = "{{$nama_kamar}}"
        document.querySelector("#txt_lantai").value = "{{$lantai}}"
        document.querySelector("#txt_deskripsi_kamar").value = "{{$deskripsi_kamar}}"
        document.querySelector("#txt_status").value = "{{$status}}"
        document.querySelector("#txt_harga").value = "{{$harga}}"
        document.querySelector("#txt_foto_kamar").value = "{{$foto_kamar}}"
    ...
    const edit = () => {
        ...
        const check = (kode_kamar[2] === 0 && nama_kamar[2] === 0 && lantai[2] === 0 && deskripsi_kamar[2] === 0 && status[2] === 0 && harga[2] === 0 && foto_kamar [2] === 0) ?
            ...
            editData(document.querySelector("#txt_kode_kamar").value,document.querySelector("#txt_nama_kamar").value, document.querySelector("#txt_lantai").value,
        ...
        const editData = async (kode_kamar, nama_kamar, lantai, deskripsi_kamar, status, harga, foto_kamar) => {
            // Collecting data
            let data = {
            ...
            try {
                ...
                let response = await fetch("{{ url('/Admin/vw_kamar/edit_kamar/editKamar') }}/"+kode_kamar_lama, {
                    method: "PUT",
                    headers: {
