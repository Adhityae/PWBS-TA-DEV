...
<title>Sistem Admin E-KOS | Edit Data Komplain</title>
@endsection
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title mt-5">Edit Data Komplain</h3>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txt_kode_user" name="txt_kode_user">
                                    ...
                                    <option id="txt_kode_user" name="txt_kode_user" value="{{ $output->kode_user }}">{{ $output->kode_user }} | {{ $output->nama }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txt_kode_kamar" name="txt_kode_kamar">
                                    ...
                                    <option id="txt_kode_kamar" name="txt_kode_kamar" value="{{ $output->kode_kamar }}">{{ $output->kode_kamar }} | {{ $output->nama_kamar }}</option>
                                    @endforeach
                                </select>
...
<script>
    ...
    document.getElementById("btn_batal").addEventListener('click',
        function () {
            location.href = '{{ url('Admin/vw_komplain/edit_komplain') }}'
        })
    ...
    let kode_komplain_lama = "{{$kode_komplain_lama}}"

        document.querySelector("#txt_kode_komplain").value = "{{$kode_komplain}}"
        document.querySelector("#txt_kode_user").value = "{{$kode_user}}"
        document.querySelector("#txt_kode_kamar").value = "{{$kode_kamar}}"
        document.querySelector("#txt_perihal").value = "{{$perihal}}"
        document.querySelector("#txt_isi").value = "{{$isi}}"
    ...
    const edit = () => {
        ...
        const check = (kode_komplain[2] === 0 && kode_user[2] === 0 && kode_kamar[2] === 0 && perihal[2] === 0 && isi[2] === 0 && status[2] === 0) ?
            ...
            editData(document.querySelector("#txt_kode_komplain").value,document.querySelector("#txt_kode_user").value, document.querySelector("#txt_kode_kamar").value,
        ...
        const editData = async (kode_komplain, kode_user, kode_kamar, perihal, isi, status) => {
            // Collecting data
            let data = {
            ...
            try {
                ...
                let response = await fetch("{{ url('/Admin/vw_komplain/edit_komplain/editKomplain') }}/"+kode_komplain_lama, {
                    method: "PUT",
                    headers: {
